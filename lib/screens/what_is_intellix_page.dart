                    ...
                    gradient: RadialGradient(
                      colors: isDarkMode
                          ...
                          : [
                              ...
                              const Color(0xFFBAE6FD).withOpacity(0.2),
                            ],
                    ),
                  ),
                ),
                ...
                decoration: BoxDecoration(
                  gradient: isDarkMode
                      ? LinearGradient(
                          ...
                          colors: [
                            const Color(0xFF132F4C).withOpacity(0.9),
                  ...
                  border: Border.all(
                    color: isDarkMode
                        ? const Color(0xFF1E4976).withOpacity(0.5)
                ...
                decoration: BoxDecoration(
                  gradient: isDarkMode
                      ? LinearGradient(
                          ...
                          colors: [
                            const Color(0xFF1E4976).withOpacity(0.2),
              ...
              decoration: BoxDecoration(
                gradient: isDarkMode
                    ? LinearGradient(
                        ...
                        colors: [
                          const Color(0xFF132F4C).withOpacity(0.6),
                          const Color(0xFF1E4976).withOpacity(0.4),
                          const Color(0xFF0A1929).withOpacity(0.4),
                        ],
                      )
                    : LinearGradient(
                        begin: Alignment.centerLeft,
